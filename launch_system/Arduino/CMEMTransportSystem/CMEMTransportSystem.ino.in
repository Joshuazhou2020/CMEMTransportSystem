...
int intervalXOn=100; //20 is a good number          
int intervalTOff=15;           // interval at which to blink (milliseconds)
int intervalYOn=100;           // interval at which to blink (milliseconds)
int ver=1;

int test = 0; //test run 

String base="";
String coil="p1d_magnet"; //plastic or copper, N means # of intervals
